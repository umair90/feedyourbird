...
local img_2 = "graphics/wheel.png"
local img_3 = "graphics/crate.png"
local icon_1
local icon_2
local icon_3
local count
...
function bird_scene()
              self.upperLeftStrip = director:createSprite( {
                name = "left",
                x = dw*1.78/4, y = 275,
                source="graphics/stripLargeStatic.png",
                xAnchor=0.5, yAnchor=0.5,
              })
              self.upperRightStrip = director:createSprite( {
                name = "left",
                x = dw*3.05/4, y = 275,
                source="graphics/stripLargeStatic.png",
                xAnchor=0.5, yAnchor=0.5,
              })
              self.lowerLeftStrip = director:createSprite( {
                name = "left",
                x = dw*1.78/4, y = 150,
                source="graphics/stripLargeStatic.png",
                xAnchor=0.5, yAnchor=0.5,
             ...
             self.lowerRightStrip = director:createSprite( {
                name = "left",
                x = dw*3.05/4, y = 150,
                source="graphics/stripLargeStatic.png",
                xAnchor=0.5, yAnchor=0.5,
              })
            self.lowerSmallStrip = director:createSprite( {
                name = "left",
                x = dw*1/4, y = 150,
            ...
            self.upperWheel = director:createSprite( {
                name = "left",
                x = dw*2.37/4, y = 305,
            ...
            self.lowerWheel = director:createSprite( {
                name = "left",
                x = dw*2.3/4, y = 180,
                source="graphics/Wheel.png",
                xAnchor=0.5, yAnchor=0.5,
...
physics:addNode(self.upperLeftStrip,{type="static"})
physics:addNode(self.upperRightStrip,{type="static"})
physics:addNode(self.lowerLeftStrip,{type="static"})
physics:addNode(self.lowerRightStrip,{type="static"})
physics:addNode(self.lowerSmallStrip,{type="static"})
physics:addNode(self.upperWheel,{radius=38,restitution=0.75})
physics:addNode(self.lowerWheel,{radius=38,restitution=1})
...
dbg.print("level12 tearDown starts")
physics:removeNode(self.player)    --Removing Physics Nodes
physics:removeNode(self.bar)

physics:removeNode(self.upperLeftStrip)
physics:removeNode(self.upperRightStrip)
physics:removeNode(self.lowerLeftStrip)
physics:removeNode(self.lowerRightStrip)
physics:removeNode(self.lowerSmallStrip)
physics:removeNode(self.upperWheel)
physics:removeNode(self.lowerWheel)

self.player:removeFromParent()      --Removing Nodes from Parents
self.bar:removeFromParent()
self.bg:removeFromParent()
self.upperLeftStrip:removeFromParent()
self.upperRightStrip:removeFromParent()
self.lowerLeftStrip:removeFromParent()
self.lowerRightStrip:removeFromParent()
self.lowerSmallStrip:removeFromParent()
self.upperWheel:removeFromParent()
self.lowerWheel:removeFromParent()
...
---------------
director:getCurrentScene():releaseAtlas(self.upperLeftStrip.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.upperLeftStrip.animation)

director:getCurrentScene():releaseAtlas(self.upperRightStrip.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.upperRightStrip.animation)

director:getCurrentScene():releaseAtlas(self.lowerLeftStrip.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.lowerLeftStrip.animation)

director:getCurrentScene():releaseAtlas(self.lowerRightStrip.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.lowerRightStrip.animation)

director:getCurrentScene():releaseAtlas(self.lowerSmallStrip.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.lowerSmallStrip.animation)

director:getCurrentScene():releaseAtlas(self.upperWheel.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.upperWheel.animation)

director:getCurrentScene():releaseAtlas(self.lowerWheel.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.lowerWheel.animation)
...
if crate_3 then
physics:removeNode(crate_3)
crate_3:removeFromParent()
director:getCurrentScene():releaseAtlas(crate_3.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(crate_3.animation)
crate_3 = nil
end
 if self.enemy then
  self.enemy:removeFromParent()
...
if icon_3 then
  icon_3:removeFromParent()
  director:getCurrentScene():releaseAtlas(icon_3.animation.usedAtlases)
  director:getCurrentScene():releaseAnimation(icon_3.animation)
  icon_3 = nil
end 
...
rain_drop  = nil
count = nil
self.upperLeftStrip=nil
self.upperRightStrip=nil
self.lowerLeftStrip=nil
self.lowerRightStrip=nil
self.lowerSmallStrip=nil
self.upperWheel=nil
self.lowerWheel=nil
rain = nil
createCrate =  nil
...
director:cleanupTextures()
print("Mem. at end of Level 12    "..math.floor(collectgarbage("count")))
