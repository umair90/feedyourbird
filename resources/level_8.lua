...
function scene:setUp(event)
 ...
 local crateCounter = 1                                     -- a counter for clicks to palace number of objects
  scoreHigh=get_highScore8()                                                          -- initialize objects here	
dbg.print("level8 setup scene started")
...
function scene:tearDown(event)
                                    --remove objects here
dbg.print("level8 tearDown starts")
...
director:cleanupTextures()
print("Mem. at end of Level8    "..math.floor(collectgarbage("count")))
