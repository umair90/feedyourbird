...
scoreHigh=get_highScore7()
  --initialize objects here	
dbg.print("level7 setup scene started")
 set_level(7)
 set_stage(2)
...
function bird_scene()
  self.upperRightSmall = director:createSprite( {
                name = "slope2",
                x = 405, y = 200,
                source="graphics/stripMediumStatic.png",
                xAnchor=0.5, yAnchor=0.5,
    ...
    self.upperLeftSmall = director:createSprite( {
                name = "slope4",
                x = 285, y = 200,
                source="graphics/stripMediumStatic.png",
                xAnchor=0.5, yAnchor=0.5,
    ...
    self.lowerRight = director:createSprite( {
                name = "slope11",
                x = 475, y = 120,
                source="graphics/stripMediumStatic.png",
                xAnchor=0.5, yAnchor=0.5,
    ...
    self.lowerLeft = director:createSprite( {
                name = "slope33",
                x = 200, y = 120,
                source="graphics/stripMediumStatic.png",
                xAnchor=0.5, yAnchor=0.5,
     ...
     self.lowerleftWheel = director:createSprite( {
                name = "slope33",
                x = 195, y = 220,
     ...
     self.lowerrightWheel = director:createSprite( {
                name = "slope33",
                x = 480, y = 230,
                source="graphics/wheelBig.png",
                xAnchor=0.5, yAnchor=0.5,
    ...
    physics:addNode(self.upperRightSmall, {type="static", density = 4})
    physics:addNode(self.upperLeftSmall, {type="static", density = 5})        
    physics:addNode(self.lowerRight, {type="static", density = 5})        
    physics:addNode(self.lowerLeft, {type="static", density = 5})        
    physics:addNode(self.lowerleftWheel, { density = 5,radius=43})     
    physics:addNode(self.lowerrightWheel, { density = 5,radius=43})
    ...
    local moveEnemy = function(event)
       --   self.enemy:removeTimer(rain, 0.20)
          ...
          director:cleanupTextures()
            ...
            print("success and level counter is "..level_complete_counter)                          -- level complete counter is set to 200 as player collides with enemy, so move to level fail screen
            ...
            print("Lost and level counter is "..level_complete_counter)   
...
function scene:tearDown(event)
                                        --remove objects here
dbg.print("level7 tearDown starts")
...
--physics:removeNode(self.upperRight)       
physics:removeNode(self.upperRightSmall)        
--physics:removeNode(self.upperLeft)        
physics:removeNode(self.upperLeftSmall)        
physics:removeNode(self.lowerRight)        
physics:removeNode(self.lowerLeft)        
--physics:removeNode(self.stripRight)        
physics:removeNode(self.lowerrightWheel) 
physics:removeNode(self.lowerleftWheel) 
--physics:removeNode(self.stripLeft) 
                                        --Remove variables
...
--self.upperRight:removeFromParent()       
self.upperRightSmall:removeFromParent()        
--self.upperLeft:removeFromParent()        
self.upperLeftSmall:removeFromParent()        
self.lowerRight:removeFromParent()       
self.lowerLeft:removeFromParent()        
-- self.stripRight:removeFromParent()  
self.lowerrightWheel:removeFromParent()
self.lowerleftWheel:removeFromParent()   
--self.stripLeft:removeFromParent() 
...
----------------
director:getCurrentScene():releaseAtlas(self.upperRightSmall.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.upperRightSmall.animation)

director:getCurrentScene():releaseAtlas(self.upperLeftSmall.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.upperLeftSmall.animation)

director:getCurrentScene():releaseAtlas(self.lowerRight.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.lowerRight.animation)

director:getCurrentScene():releaseAtlas(self.lowerLeft.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.lowerLeft.animation)

director:getCurrentScene():releaseAtlas(self.lowerrightWheel.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.lowerrightWheel.animation)

director:getCurrentScene():releaseAtlas(self.lowerleftWheel.animation.usedAtlases)
director:getCurrentScene():releaseAnimation(self.lowerleftWheel.animation)
...
--crate_3 = nil
--self.upperRight = nil       
self.upperRightSmall  = nil       
--self.upperLeft = nil        
self.upperLeftSmall = nil        
self.lowerRight = nil       
self.lowerLeft = nil        
--self.stripRight = nil    
self.lowerrightWheel=nil
self.lowerleftWheel=nil
--self.stripLeft = nil 
...
director:cleanupTextures()
print("Mem. at end of Level7    "..math.floor(collectgarbage("count")))
